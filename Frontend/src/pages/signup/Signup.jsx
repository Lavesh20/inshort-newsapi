...
const SignUpPage = () => {
  ...
  // Handle Google Signup (Now using Firebase)
        ...
        <div className="px-6 py-8 sm:px-10">
          ...
          <form id="signup-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-center">
              <button
                type="button"
                className="w-full py-3 px-4 bg-red-600 text-white rounded-lg shadow-sm hover:bg-red-700"
            ...
            <div className="flex items-start">
              ...
              <label htmlFor="agreeToTerms" className="ml-3 text-sm text-gray-600">
                I agree to the <a href="#" className="text-indigo-600 hover:text-indigo-800 font-medium">Terms of Service</a> and{" "}
                <a href="#" className="text-indigo-600 hover:text-indigo-800 font-medium">Privacy Policy</a>
              </label>
            </div>

            {/* Submit Button */}
            <button type="submit" className="w-full py-3 px-4 bg-indigo-600 text-white rounded-lg shadow-sm hover:bg-indigo-700">
              Create Account
            </button>
          </form>
        </div>
