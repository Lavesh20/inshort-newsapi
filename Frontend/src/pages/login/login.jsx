...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/en/general'); // Redirect after login
    } catch (err) {
      setError('Invalid email or password. Please try again.');
      console.error('Login error:', err);
    }
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="relative mt-1">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                  <input
                    ...
                    onChange={() => setShowPassword(!showPassword)}
                  />
                  <label htmlFor="show-password" className="ml-2 block text-sm text-gray-900">Show</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="/en/forgot-password" className="font-medium text-indigo-600 hover:text-indigo-500">Forgot your password?</a>
            </div>
          </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-600">
            Don't have an account?{' '}
            <a href="/en/signup" className="font-medium text-indigo-600 hover:text-indigo-500">Sign up</a>
          </p>
        </div>
      </div>
    </div>
